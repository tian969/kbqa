...
OUT_PATH = config['sql_data']['company_annual_reports_path']  # ./data/company_annual_reports.xlsx
valid_pdf_name = config['guanfang_data']['valid_pdf_name']  # /tcdata/C-list-pdf-name.txt
